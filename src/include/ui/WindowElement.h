    ...
    class WindowElement {
        ...
        */
        ...
        public:
            ...
            virtual void draw(Gui::Drawer* drawer, Vec2* offset);
            ...
            WindowElement* doInput(Gui::State* state, Vec2* offset);
            ...
            virtual void onInput(Gui::State* state) {}
        ...
        protected:
            ...
            void drawChildren(Gui::Drawer* drawer, Vec2* offset);
    ...
    class WindowDiv : public WindowElement {
        ...
        */
        ...
        public:
            ...
            void draw(Gui::Drawer* drawer, Vec2* offset) override;
    ...
    class WindowTextInput : public WindowElement {
        ...
        */
        ...
        public:
            ...
            void onInput(Gui::State* state) override;
