...
// Constructor
Gui::Window::Window(WindowProcFunc windowProcFunc, int windowWidth, int windowHeight, LPCSTR windowTitle /* default value = "Window" */) {
...
// Instance functions
void Gui::Window::updateDimensions(int width, int height) {
...
void Gui::Window::handleMessages() const {
...
void Gui::Window::setCursorState(CursorState cursorState) {
